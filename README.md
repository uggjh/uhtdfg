...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/uggjh/uhtdfg) 
...
* The default protocol password is 338df77f-6003-4b83-a015-6c3835fa4f6d, the WS path is $UUID-[vmess|vless|trojan|ss|socks] format

### Client
* ** Be sure to replace all `xxx.herokuapp.com` to your project domain name assigned to heroku**
* ** Be sure to replace all `338df77f-6003-4b83-a015-6c3835fa4f6d` UUIDs set during deployment, it is recommended to change, not everyone should be the same **
...
* Port：443
* Default UUID：338df77f-6003-4b83-a015-6c3835fa4f6d
* vmess alter ID：0
* encryption：none
